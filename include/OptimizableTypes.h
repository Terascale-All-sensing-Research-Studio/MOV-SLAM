...
#ifndef MOV_SLAM_OPTIMIZABLETYPES_H
#define MOV_SLAM_OPTIMIZABLETYPES_H
...
namespace MOV_SLAM
{
    ...
    class EdgeSim3ProjectXYZ : public g2o::BaseBinaryEdge<2, Eigen::Vector2d, g2o::VertexPointXYZ, MOV_SLAM::VertexSim3Expmap>
    {
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW
        EdgeSim3ProjectXYZ();
        ...
        void computeError()
        {
            const MOV_SLAM::VertexSim3Expmap *v1 = static_cast<const MOV_SLAM::VertexSim3Expmap *>(_vertices[1]);
            const g2o::VertexPointXYZ *v2 = static_cast<const g2o::VertexPointXYZ *>(_vertices[0]);
...
#endif // MOV_SLAM_OPTIMIZABLETYPES_H
