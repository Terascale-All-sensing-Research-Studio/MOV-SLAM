...
namespace MOV_SLAM
{
    ...
    public:
        ...
        Sophus::SE3f GrabImageMonocular(const double &timestamp, const shared_ptr<MotionVectorImage> &smv);

        Sophus::SE3f GrabImageStereo(const double &timestamp, const shared_ptr<MotionVectorImage> &smv, const shared_ptr<MotionVectorImage> &smvRight);
