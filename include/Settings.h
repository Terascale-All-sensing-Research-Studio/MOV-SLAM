...
#ifndef MOV_SLAM_SETTINGS_H
#define MOV_SLAM_SETTINGS_H
...
namespace MOV_SLAM
{
    ...
    public:
        ...
        double coverageThreshold() { return coverageThreshold_; }
        double relocalizationDistance() { return relocalizationDistance_; }

        int iterationCount() { return iterationCount_; }
        double reprojectionError() { return reprojectionError_; }
        double reprojectionErrorLost() { return reprojectionErrorLost_; }
    ...
    private:
        ...
        void readMOV(cv::FileStorage &fSettings);
        void readOptimization(cv::FileStorage &fSettings);
        ...
        int threshold_;
        double coverageThreshold_;
        double relocalizationDistance_;

        int iterationCount_;
        double reprojectionError_;
        double reprojectionErrorLost_;
        double confidence_;
        int algorithm_;
