...
namespace MOV_SLAM
{
    ...
    public:
        ...
        MapPoint(const Eigen::Vector3f &Pos, KeyFrame *pRefKF, Map *pMap, int trackId);
        MapPoint(const double invDepth, cv::Point2f uv_init, KeyFrame *pRefKF, KeyFrame *pHostKF, Map *pMap, int trackId);
        MapPoint(const Eigen::Vector3f &Pos, Map *pMap, Frame *pFrame, const int &idxF, int trackId);
